...
public class ChatAdapter extends BaseAdapter {
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            holder.contentWithBG.setBackgroundResource(R.drawable.my_button_chat);

            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) holder.contentWithBG.getLayoutParams();
            layoutParams.gravity = Gravity.RIGHT;
            holder.contentWithBG.setLayoutParams(layoutParams);
            holder.contentWithBG.setPadding(20,20,20,20);
            ...
            holder.txtInfo.setTextColor(Color.WHITE);
        } else {
            holder.contentWithBG.setBackgroundResource(R.drawable.my_button_signup);
            ...
            layoutParams.gravity = Gravity.LEFT;
            holder.txtMessage.setLayoutParams(layoutParams);
            holder.txtMessage.setTextColor(Color.parseColor("#c64040"));
