...
public class UserStatusService extends AsyncTask<URL, Integer, Long> {
    ...
    public UserStatusService(Context context, String mapping, List<Pair<String, String>> parameters, TaskChangeStatus taskChangeStatus) {
    ...
    protected void onPostExecute(Long result) {
        taskChangeStatus.TaskChangeStatus(response);
    }
}